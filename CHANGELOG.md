...
### Fixed
- **ANSI Parsing**: Added fallback encoding support to properly parse schematics saved by LTspice 26.
- **Test Fixtures**: Fixed hardcoded macOS library paths in testing fixtures and updated the main path resolver to intelligently locate standard Windows LTspice libraries.
